	...
	<div id="rightcolumn">
		<div class="sideitem">
			...
			<ul>
				...
				<li><a href="http://download.eclipse.org/e4/resources/e4-whitepaper.php">Read the white paper</a></li>
				...
				<li><a href="http://eclipse.org/e4/development/readme/readme_e4_0.9.html#R-Demos">Run the demos</a></li>
      		</ul>				
		</div>
	</div>
